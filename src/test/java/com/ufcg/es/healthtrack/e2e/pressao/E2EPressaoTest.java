...
public class E2EPressaoTest {
    ...
    public void éTentadoCadastrarUmNovoExameDeGlicemia() {
        response = given().
                ...
                body(new PressaoDTO(1,1,"obs")).port(port).
                when().post("api/v1/exame/pressao");
    }
    ...
    public void éTentadoListarTodosOsExames() {
        response = given().
                ...
                when().get("api/v1/exame/pressao/listar");
    }
    ...
    public void éTentadoVisualizarTodosOsExames(String id) {
        response = given().
                header(new Header("Authorization", token)).
                port(port).
                when().get("api/v1/exame/pressao/"+id);
    }

    @And("Existe um exame cadastrado")
    public void existeUmExameCadastrado() {
        PressaoDTO exame = new PressaoDTO(1,1,"obs");
